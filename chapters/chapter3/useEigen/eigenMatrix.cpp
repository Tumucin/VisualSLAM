...
using namespace Eigen;
 ...
 int main()
 { 
   // Define 2*3 float matrix
   Matrix<float, 2, 3> matrix_23;

   Vector3d v_3d;
   
   // This is the same as v_3d
   Matrix<float, 3, 1> vd_3d;

   // Matrix3d is essentially Matrix<double, 3, 3>
   Matrix3d matrix_33 = Matrix3d::Zero(); // ınıtlaızed to zero

   // ıf you are not sure of the matrix size , use dynamic size
